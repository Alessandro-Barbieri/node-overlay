...
delete-empty@3.0.0
depcheck@1.4.0
depcheck-detector-execa@1.2.14
depcheck-detector-package-name@1.0.10
depcheck-package-name@1.0.7
depcheck-parser-babel@1.2.15
depd@1.1.2
deprecation@2.3.1
deps-regex@0.1.4
detect-file@1.0.0
...
dot-prop@5.3.0
duplexer2@0.1.4
@dword-design/babel-config@1.9.0
@dword-design/base-config-node@1.9.16
@dword-design/chdir@1.0.11
@dword-design/ci@2.0.7
@dword-design/eslint-config@1.27.17
@dword-design/eslint-plugin-import-alias@1.5.2
@dword-design/functions@3.0.5
@dword-design/proxyquire@1.0.14
@dword-design/tester@1.2.9
@dword-design/tester-plugin-tmp-dir@1.0.5
ecc-jsbn@0.1.2
...
expand-tilde@2.0.2
expect@26.6.2
expect-mocha-image-snapshot@1.0.12
...
getpass@0.1.7
get-projectz-readme-section-regex@2.0.12
get-stdin@5.0.1
get-stdin@8.0.0
get-stream@4.1.0
get-stream@5.2.0
...
mocha@8.3.2
mocha-ui-exports-auto-describe@1.0.17
modify-values@1.0.1
...
SRC_URI="
	https://github.com/dword-design/base/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	https://codeload.github.com/dword-design/dedent/tar.gz/c8d46e5017d60504657c2d01b59082c0329a12a7 -> dedent-c8d46e5017d60504657c2d01b59082c0329a12a7.tgz
...
BDEPEND=" || ( net-libs/nodejs[npm] dev-node/npm )"

PATCHES=( "${FILESDIR}/${PV}-package-json.patch" )

S="${WORKDIR}/${PN#*+}-${PV}"

src_prepare() {
	cp -f "${FILESDIR}/${PV}-package-lock.json" package-lock.json || die
